...
const VendorOrderDetails = () => {
  ...
  const { currentOrder, detailsLoading, loading, error, success } = useSelector(
    ...
    dispatch(
      updateOrderItemFulfillment({
        ...
        data: {
          ...
          fulfillmentStatus,
          trackingInfo:
            fulfillmentStatus === "shipped" ? trackingInfo : undefined,
        },
      })
    );
  };
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-4">
            ...
            >
              {selectedItems.length === currentOrder?.items.length
                ? "Deselect All"
                : "Select All"}
            </button>
          </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          >
                            {(item.fulfillmentStatus || "pending")
                              .charAt(0)
                              .toUpperCase() +
                              (item.fulfillmentStatus || "pending").slice(1)}
                          </span>
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        You are updating the status of {selectedItems.length}{" "}
